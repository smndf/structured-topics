...
public class PipelineEvaluation {
	...
	public static void main(String[] args) {
		String[] topicsFiles = {"good_clustersEnrichedSynonymsAnd40Hyps.txt"};
	...
	public static void run(String topicsFile) {
		...
		Map<String,Set<String>> map = es.loadClusters(inputFile, "topics");
			...
			if (seemsRelevant(title)){
				...
				if (text.isEmpty()){
					...
					for (SearchHit hit : hits.getHits()) {
						results[noHit][Integer.valueOf(hit.getId())]++;
